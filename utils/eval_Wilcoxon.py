...
def Wilcoxon(gt, pred):
    print(ranksums(gt, pred))
    return ranksums(gt, pred)
...
def evaluate(args):
    rst_dict = dict(NMSE=[], PSNR=[], SSIM=[], nameList=[], Wilcoxon=[])
