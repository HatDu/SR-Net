...
def evaluate(args):
    ...
    for fname in tqdm(sorted(os.listdir(args.pred_dir))):
        ...
        # recon = data['y_hat_k']
        recon = data['recon'][..., 82:84]
        target = data['images'][..., 82:84]
...
if __name__ == '__main__':
    ...
    rst_csv.close()
# python .\utils\eval_tvmat.py --pred-dir C:\Users\dnm\Desktop\TV\Cartesian_X4\infer\ --out-path C:\Users\dnm\Desktop\TV\Cartesian_X4\
